    ...
    <>
      ...
      {!isConfiguring && (
        <>
          ...
          <div className="absolute bottom-0 left-0 right-0 md:bottom-4 md:left-4 md:right-auto md:w-[390px] bg-white rounded-t-3xl md:rounded-2xl shadow-2xl border-t md:border border-gray-100 p-3 pt-4 pb-[calc(0.75rem+env(safe-area-inset-bottom))] md:p-4 md:pt-5 md:pb-4 z-[999] pointer-events-auto flex flex-col gap-2.5 md:gap-3 max-h-[45vh] md:max-h-none overflow-y-auto">
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <div className="grid grid-cols-3 gap-1.5 md:gap-2">
                <button
                  onClick={() => handleCalculateRoute()}
                  disabled={geocoding || routeLoading}
                  className="py-2 md:py-2.5 bg-blue-50 text-blue-600 hover:bg-blue-100 text-xs font-black rounded-xl active:scale-95 transition-all flex items-center justify-center gap-1 border border-blue-100"
                >
                  {geocoding || routeLoading ? (
                ...
                <button
                  onClick={() => setIsConfiguring(true)}
                  className="py-2 md:py-2.5 border border-gray-200 hover:bg-gray-50 text-gray-700 text-xs font-black rounded-xl active:scale-95 transition-all text-center"
                >
                  Editar
                </button>
                <button
                  onClick={handleExit}
                  className="py-2 md:py-2.5 bg-red-500 hover:bg-red-600 text-white text-xs font-black rounded-xl active:scale-95 shadow-sm hover:shadow transition-all text-center"
                >
                  Salir
                </button>
              </div>
